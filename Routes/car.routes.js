...
router.post('/interior-images/:id', protect, authorize('admin', 'superadmin'), upload.array('images', 5), addInteriorImages)
router.post('/exterior-images/:id', protect, authorize('admin', 'superadmin'), upload.array('images', 5), addExteriorImages)
